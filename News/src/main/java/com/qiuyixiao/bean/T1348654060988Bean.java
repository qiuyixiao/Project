...
public class T1348654060988Bean {
    ...
    private int imgsum;
    private List<WapBean> wap_pluginfo;
    ...
    public List<WapBean> getWap_pluginfo() {
        return wap_pluginfo;
    }

    public void setWap_pluginfo(List<WapBean> wap_pluginfo) {
